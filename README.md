...
All three architectures save to the same model file, so training a Deeper CNN overwrites whatever was there. Can't compare models side by side. Something to sort out later.
...
```
gradio_phase11/
├── app_ui.py          # Main application (207 lines, +15 from Phase 10)
├── models.py          # 3 architectures (116 lines, +51)
